...
def getYouTubeAudio(link: str):
    ...
    return generate2(audio_stream, "audio/mp3")

def generate2(video_stream, _media_type):
    ...
    response.headers["Content-Disposition"] = "attachment; filename="+ video_stream.title + ".mp4"
